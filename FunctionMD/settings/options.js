 ...
 limitawal: 15,
 info: {
   owner: ["628889091050@s.whatsapp.net","628884919004@s.whatsapp.net"], //Yang Awal Nomor Bot Yang Kedua Nomor Lu
   arielspkece: ["628889091050","628884919004"], //Nomor Lu
   ownerName: "RAIHAN DS", //Nama Lu
   wmAriel: "628884919004", //Nomor Lu
   youtubeLu: "https://instagram.com/meme_rewceh?igshid=YmMyMTA2M2Y=", //Youtube Lu
   botName: "NGIXING", //Nama Bot Lu
   gcwa: "https://chat.whatsapp.com/HN9jAlFmSLgIKbpX4v19Ml", //group Lu
   version: "^2.0.0"
   },
 rpg: {
   darahawal: 100,
